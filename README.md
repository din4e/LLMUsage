...
| Kimi Code / Moonshot API | China | Experimental Kimi Code usage endpoint with official Moonshot balance fallback | Kimi Code 5-hour and weekly quota, or Moonshot CNY balance for an Open Platform key |
...
| MiniMax | China | Official Token Plan remains endpoint with same-region host fallback | Plan used/remaining percentage, model and reset time when returned |
